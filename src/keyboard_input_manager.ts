function KeyboardInputManager(this:any) {
  this.events = {};
...
KeyboardInputManager.prototype.on = function (event:any, callback:Function) {
...
KeyboardInputManager.prototype.emit = function (event:any, data:any) {
...
KeyboardInputManager.prototype.restart = function (event:any) {
  event.preventDefault();
  this.emit("restart");
};

KeyboardInputManager.prototype.keepPlaying = function (event:any) {
  event.preventDefault();
  this.emit("keepPlaying");
};

KeyboardInputManager.prototype.bindButtonPress = function (selector:any, fn:Function) {
